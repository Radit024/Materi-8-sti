...
const Hero = () => {
  return <div className="relative bg-farm-dark-green text-farm-light-cream">
      {/* Background pattern */}
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative rounded-lg overflow-hidden shadow-xl">
              <img src="https://images.unsplash.com/photo-1515150144380-bca9f1650ed9" alt="Farmer's Market Fresh Produce" className="w-full h-auto object-cover" />
